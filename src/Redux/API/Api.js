const baseURL = "https://guarantees.boxbyld.tech/api"
export const register = `${baseURL}/register-user`;
...
export const show_lead = `${baseURL}/leads-bank/show-available-lead`;
...
export const state = `${baseURL}/countries/country`;
